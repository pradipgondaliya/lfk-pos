...
<head>
    ...
    <title>Customer List | LFK POS</title>
...
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <button class="btn btn-primary pull-right mb-3" data-bs-toggle="modal" data-bs-target="#myModal">Add Customer</button>
            </div>
        </div>
        <table class="table table-bordered display" id="editableTable">
            ...
            <tbody>
              <tr data-id="1">
                <td data-field="">12358</td>
                <td data-field="">Jhon Doe</td>
                <td data-field="">8585067590</td>
                <td data-field="">22/07/2023</td>
                <td data-field=""><span class="badge bg-primary">Complete</span></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="">Order Collection Date</label>
